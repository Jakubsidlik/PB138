...
import { studyPlansRouter } from './study-plans/study-plans.routes.js'
import { subjectsRouter } from './subjects/subjects.routes.js'
import { usersRouter } from './users/users.routes.js'
import { filesRouter, adminFilesRouter, fileCommentsRouter } from './files/files.routes.js'
import { lessonsRouter, lessonNotesRouter, annotationsRouter } from './lessons/lessons.routes.js'
